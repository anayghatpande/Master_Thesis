...
cfg_file = "/home/iiwa-2/Frameworks/Open3D-ML/ml3d/configs/randlanet_semantickitti.yml"
cfg = _ml3d.utils.Config.load_from_file(cfg_file)

model = ml3d.models.RandLANet(**cfg.model)
cfg.dataset['dataset_path'] = "/home/iiwa-2/Downloads/data_odometry_velodyne"
#dataset_path = "/home/iiwa-2/Downloads/Datasets/HOPE/"
#dataset = ml3d.datasets.HopeDataset(dataset_path=dataset_path, name='HopeDataset', train_dir='train', test_dir='test', val_dir='val')
...
# dataset = ml3d.datasets.Custom3D(dataset_path='/home/iiwa-2/Downloads/Datasets/HOPE_S3ID/mmdet3d/data/s3dis/FLW_dataset', cache_dir='./logs/cache', training_split=['00', '01', '02', '03', '04', '05', '06', '07', '09'])
